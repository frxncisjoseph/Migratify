...
/**
 * Converts Magento PHTML to Liquid markup language.
 * @param {String} templateSyntax The template syntax to be parsed.
 */
const parseMagentoPHTML = async (templateSyntax) => {
  throw "Not Implemented";
}

/**
 * Converts BigCommerce variables (also called placeholders) to Liquid markup language.
 * @param {String} templateSyntax The template syntax to be parsed.
 */
const parseBigCommerceVariable = async (templateSyntax) => {
  throw "Not Implemented";
}